...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_0__["default"])('.quastions__card', '.quastions__rightbtn');
});
...
var sliders = function sliders(sliderSelector, nextSelector) {
  ...
  try {
    ...
    nextBtn.addEventListener('click', function () {
      console.log('touch');
      plusSlides(+1); // this.parentNode.previousElementSibling.style.display = 'none';
